...
func LabelAddHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.LabelAddReq
		...
		l := label.NewLabelAddLogic(r.Context(), svcCtx)
		resp, err := l.LabelAdd(&req)
