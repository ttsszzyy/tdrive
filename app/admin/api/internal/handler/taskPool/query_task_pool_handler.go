...
func QueryTaskPoolHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.QueryTaskPoolReq
		...
		l := taskPool.NewQueryTaskPoolLogic(r.Context(), svcCtx)
		resp, err := l.QueryTaskPool(&req)
