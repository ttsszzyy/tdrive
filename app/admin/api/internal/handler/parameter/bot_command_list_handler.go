...
func BotCommandListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.BotCommandListReq
		...
		l := parameter.NewBotCommandListLogic(r.Context(), svcCtx)
		resp, err := l.BotCommandList(&req)
