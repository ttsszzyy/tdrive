...
func QueryParameterHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.QueryParameterReq
		...
		l := parameter.NewQueryParameterLogic(r.Context(), svcCtx)
		resp, err := l.QueryParameter(&req)
